...
class TorchABMCovid():
    ...
    def step(self):
        ...
        # people who are vaccinated go to an asymptomatic stage
        vaccinated_asymptomatic_index = torch.logical_and(infected_now_pre_vaccine.bool(), self.agents_vaccination_effectiveness[t, :].bool()).view(-1)
        self.agents_stages[t + 1, vaccinated_asymptomatic_index.bool()] = 1 # moving vaccinated to asymptomatic  # torch.distributions.Categorical(probs=probs).sample()
